			...
			<div className="PrivacyBanner">
				<div className="PrivacyBanner--left">
					<p className="PrivacyBanner--text">
						We use cookies from external service providers in order to collect statistics about the usage of the site. This information is anonymized, and cannot be connected to individual users. See our <a href="https://www.hackjunction.com/policy" alt="Privacy Policy"> Privacy policy</a> and <a href="https://www.hackjunction.com/terms" alt="terms"> Terms & Conditions </a> for details on how we use your data.
					</p>
				</div>
