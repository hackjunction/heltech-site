...
export const shouldUpdate = createSelector(contentUpdated, (updated) => {
...
export const speakerCards = createSelector(speakers, (data) => {
    return filter(data, ['isOldSpeaker', !true]);
});

export const oldSpeakers = createSelector(speakers, (data) => {
    return filter(data, 'isOldSpeaker');
});

export const teammembersByPriority = createSelector(teammembers, (data) => {
    return data; //.sortBy('priority');
});

export const mainPartners = createSelector(partners, (data) => {
    return filter(data, 'mainPartner');
});
export const supportingPartners = createSelector(partners, (data) => {
